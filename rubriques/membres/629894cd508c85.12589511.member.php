    ...
    <body>
            ...
            <div class="membre-container">
                <div class="membre-content">
                    <div class="left-membre">
                        <ul>
                            <li> <img src="../../content/images/6h-1_0.jpeg" alt="" class="profile"></li>
                            <li> <h3 class="nom-prenom">Pristiano Penaldo</h3></li>
                            <li> <span class="adresse">Sir Matt Busby Way, Old Trafford, Stretford, Manchester M16 0RA, Royaume-Uni</span></li>
                            <li> <span class="email">pristiano@gmail.com</span></li>
                            <li> <span class="tel">0636811141</span></li>
                            <li>
        ...
        <footer>
            ...
            <ul class="menu_footer">
                ...
                <li> <a href="../rubriques/gfc/contact.php">GFC PHARMA</a></li>
            </ul>
        </footer>
        <script>
            ...
            fetchText("Sir Matt Busby Way, Old Trafford, Stretford, Manchester M16 0RA, Royaume-Uni");
