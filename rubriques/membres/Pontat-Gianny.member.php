    ...
    <body>
            ...
            <div class="membre-container">
                <div class="membre-content">
                    <div class="left-membre">
                        <ul>
                            <li> <img src="../../content/profile/62acf892ba3c75.60879782.jpg" alt="" class="profile"></li>
                            <li> <h3 class="nom-prenom">Gianny Freddy</h3></li>
                            <li> <span class="adresse">4 Allee Jean Rostand 91000 Evry</span></li>
                            <li> <span class="email">pontatg@gmail.com</span></li>
                            <li> <span class="tel">0780399280</span></li>
                            <li>
                                <h2 class="description">Description</h2>
                            </li>
                            <li>
                                <p class="desctp">Sed volutpat ornare nulla. Ut vitae quam eu turpis porta dictum. Maecenas consectetur, risus at rhoncus fringilla, turpis sem imperdiet dui, eget porta massa lacus non justo. Maecenas sed risus leo. Cras vitae lacus quis tortor iaculis molestie. Aenean iaculis, ipsum non lacinia iaculis, neque nunc fermentum diam, eget vestibulum est metus sed ex. Phasellus elementum nulla eu odio sollicitudin viverra. Pellentesque interdum metus feugiat augue fringilla, eu tempor dolor tincidunt. Etiam ullamcorper lacinia neque vitae imperdiet. Pellentesque porta sodales tortor. Vivamus et arcu a tortor tempor vulputate. Pellentesque mollis turpis id nisl gravida, at placerat dolor maximus. Morbi lacinia et ipsum ac placerat. Curabitur ultrices, ligula in iaculis pellentesque, nisi nunc fermentum nunc, sit amet tristique sapien nibh id lacus. Fusce placerat, sapien ut tristique venenatis, elit tellus volutpat quam, ac rhoncus neque lectus quis tortor. Praesent sed viverra ex. </p>
                            </li>
                        </ul>
                    </div>
        ...
        <script>
            ...
            fetchText("4 Allee Jean Rostand 91000 Evry");
