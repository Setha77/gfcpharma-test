    ...
    <body>
                ...
                <div class="membre-content">
                    <div class="left-membre">
                        <ul>
                            ...
                            <li> <h3 class="nom-prenom">zearazer azrzeza</h3></li>
                            <li> <span class="adresse">59 ALEXANDRA ROAD GREAT WAKERING</span></li>
                            <li> <span class="email">aerza@gmail.com</span></li>
                            <li> <span class="tel">0780399256</span></li>
                            <li>
        ...
        <script>
            ...
            fetchText("59 ALEXANDRA ROAD GREAT WAKERING");
