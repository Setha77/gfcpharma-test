    ...
    <body>
            ...
            <div class="membre-container">
                <div class="membre-content">
                    <div class="left-membre">
                        <ul>
                            <li> <img src="../../content/profile/62acf8b5e58278.30233608.jpg" alt="" class="profile"></li>
                            <li> <h3 class="nom-prenom">Setha Potter</h3></li>
                            <li> <span class="adresse">86 Rue Olympe de gouges Moissy Cramayel</span></li>
                            <li> <span class="email">setha_hong77@hotmail.com</span></li>
                            <li> <span class="tel">0780399265</span></li>
                            <li>
                                <h2 class="description">Description</h2>
                            </li>
                            <li>
                                <p class="desctp">Je m&#039;appelle Setha. </p>
                            </li>
                        </ul>
                    </div>
        ...
        <script>
            ...
            fetchText("86 Rue Olympe de gouges Moissy Cramayel");
