            ...
            <div class="membre-container">
                <div class="membre-content">
                    <div class="left-membre">
                        <ul>
                            <li> <img src="../../content/profile/62ae05a7ce1e64.83294331.jpg" alt="" class="profile"></li>
                            <li> <h3 class="nom-prenom">Remi  cyberman</h3></li>
                            <li> <span class="adresse">46 Rue de Strasbourg Nantes</span></li>
                            <li> <span class="email">remi.sevret@gmail.com</span></li>
                            <li> <span class="tel">0780394523</span></li>
                            <li>
                                <h2 class="description">Description</h2>
                            </li>
                            <li>
                                <p class="desctp">You need help from a PHP FORUM. We can help you with jQuery.

You need to configure your PHP server to allow you to use PHP in your JS files. It is not configured for this by default.

I do not use PHP. I only know this because somebody answered the same question a few days ago. Unfortunately, I can&#039;t find that post.     </p>
                            </li>
                        </ul>
                    </div>
        ...
        <script>
            ...
            fetchText("46 Rue de Strasbourg Nantes");
