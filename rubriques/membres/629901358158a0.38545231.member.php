    ...
    <body>
                ...
                <div class="membre-content">
                    <div class="left-membre">
                        <ul>
                            ...
                            <li> <h3 class="nom-prenom">Harry azymof</h3></li>
                            <li> <span class="adresse">77 allée de la Fédération Moissy Cramayel</span></li>
                            <li> <span class="email">harry.azymof@hotmail.com</span></li>
                            <li> <span class="tel">0710111722</span></li>
                            <li>
        ...
        <script>
            ...
            fetchText("77 allée de la Fédération Moissy Cramayel");
