    ...
    <body>
                ...
                <div class="membre-content">
                    <div class="left-membre">
                        <ul>
                            ...
                            <li> <h3 class="nom-prenom">Pemmanuel Pacron</h3></li>
                            <li> <span class="adresse">55 Rue du Faubourg Saint-Honoré, 75008 Paris</span></li>
                            <li> <span class="email">pacron@gmail.com</span></li>
                            <li> <span class="tel">0636811180</span></li>
                            <li>
        ...
        <script>
            ...
            fetchText("55 Rue du Faubourg Saint-Honoré, 75008 Paris");
