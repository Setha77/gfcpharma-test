    ...
    <body>
                ...
                <div class="membre-content">
                    <div class="left-membre">
                        <ul>
                            ...
                            <li> <h3 class="nom-prenom">Pionnel Pessi</h3></li>
                            <li> <span class="adresse">C. dArístides Maillol 12 08028 Barcelona Espagne</span></li>
                            <li> <span class="email">pionnel@hotmail.com</span></li>
                            <li> <span class="tel">0780399215</span></li>
                            <li>
        ...
        <script>
            ...
            fetchText("C. dArístides Maillol 12 08028 Barcelona Espagne");
