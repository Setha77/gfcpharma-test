    ...
    <body>
                ...
                <div class="membre-content">
                    <div class="left-membre">
                        <ul>
                            ...
                            <li> <h3 class="nom-prenom">Marcelle Breton</h3></li>
                            <li> <span class="adresse">53 rue Pierre De Coubertin Toulouse</span></li>
                            <li> <span class="email">pleroy@lemoine.fr</span></li>
                            <li> <span class="tel">0735695425</span></li>
                            <li>
        ...
        <script>
            ...
            fetchText("53 rue Pierre De Coubertin Toulouse");
